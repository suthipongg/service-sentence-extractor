...
class EmbeddingModel:
    def __init__(self, model_name='BAAI/bge-m3', device='cpu', sentence_pooling_method='cls', normlized=True, temperature=1.0, enable_sub_batch=False, max_length=8192):
    ...
    def load_model(self):
        self.model = ORTModelForFeatureExtraction.from_pretrained(f"{str(pathlib.Path().resolve())}/model_ai/models/bge_m3_onnx_o2_fp16").to(self.device)
